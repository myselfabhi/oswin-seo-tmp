...
export async function generateMetadata({ params, searchParams }, parent) {
    try {
        ...
        const seoData = {
            ...
            alternates: { canonical: `https://www.oswinply.com/block-board/${slug}` },
...
const page = async ({ params }) => {
    ...
    const __breadcrumbLd = {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Block Board", "item": `https://www.oswinply.com/block-board` },
    ...
    return (
        <>
            ...
            <InnerBanner
                ...
                isHtmlTitle={true}
            />
         {usp_list.length > 0 &&   <CompanyFeatures features={usp_list}  />}
