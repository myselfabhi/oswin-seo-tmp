  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        {/* GTM #2 (Gokul, added 2026-09-02) — remove this whole <script> block to disable */}
        <script
          id="gtm-script-2"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
            __html: `
              ...
              j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;
              f.parentNode.insertBefore(j,f);
              })(window,document,'script','dataLayer','GTM-TMFNHXW4');
            `,
          }}
        />
      </head>
      <body>
        ...
        {/* GTM #2 (Gokul) noscript — remove this whole <noscript> block to disable */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TMFNHXW4"
            height="0"
            width="0"
            style={{ display: "none", visibility: "hidden" }}
          />
