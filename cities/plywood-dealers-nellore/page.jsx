...
export const metadata = {
  title: "Plywood Manufacturers in Nellore | Oswin Ply",
  description: "Oswin Ply supplies ISI-certified BWP plywood, block board, flush doors and prelam boards to Nellore. Enquire for pricing and your nearest stockist.",
  alternates: { canonical: "/plywood-dealers-nellore" },
};

const howToLd = {"@context":"https://schema.org","@type":"HowTo","name":"What to check before buying plywood in Nellore","step":[{"@type":"HowToStep","position":1,"name":"Choose the grade first","text":"Choose BWP where moisture is a factor, MR where it isn't."},{"@type":"HowToStep","position":2,"name":"Verify the ISI mark","text":"Look for the ISI mark on the board itself, not just the invoice or shop signage."},{"@type":"HowToStep","position":3,"name":"Confirm the core","text":"Ask whether the core is Gurjan/hardwood or a mixed/soft-core alternative, since it changes load-bearing performance."}]};
